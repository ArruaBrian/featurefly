...
### Fixed
- **ESLint violations**: Replaced `any` with `unknown` in `FetchError` class and test mocks to comply with strict TypeScript rules. Removed unused imports in test files. (#21)
